...
export const APRIL_QUESTS: AprilQuest[] = [
  // ── 5 kwietnia ──────────────────────────────────────────────
  ...
  // ── 30 kwietnia ─────────────────────────────────────────────
  { id: 'apr_30_1', date: '2026-04-30', title: 'Wielkie podsumowanie miesiąca', description: 'Przegląd 6 obszarów: psychika / Janek / wizerunek / kariera i finanse / relacje / tożsamość. Napisz: 10 rzeczy zrobionych dobrze, 5 do poprawy, 3 priorytety maja.', pillar: 'pozycja', xp: 200 },
]
