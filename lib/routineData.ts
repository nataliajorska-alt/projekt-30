...
export const MORNING_ROUTINE: RoutineItem[] = [
  ...
  { id: 'm6', text: 'Iskra',                            type: 'morning', xp: 10, priority: 'normal',   category: 'mental'    },
...
export const PINNED_SPARKS: Record<string, string> = {
  ...
  // ── SIERPIEŃ 2026 — ZAUFANIE SOBIE ────────────────────────────
  // Każda iskra nazywa decyzję albo kierunek, nigdy cechę (afirmacje cech
  // pogarszają nastrój przy niskiej samoocenie — Wood 2009). To zasada projektowa.
  '2026-08-01': 'Zapisuję, żeby przestało krążyć.',
  '2026-08-02': 'Wybieram trzy rzeczy i daję im godziny.',
  '2026-08-03': 'Zapisuję przewidywanie, żeby móc je sprawdzić, a nie tylko w nie wierzyć.',
  '2026-08-04': 'Dzwonię, nie czekając, aż poczuję się gotowa.',
  '2026-08-05': 'Odpowiadam sama sobie, zanim zapytam kogokolwiek.',
  '2026-08-06': 'Nie kończę wszystkiego. Kończę temat.',
  '2026-08-07': 'Ruch nie musi być zasłużony.',
  '2026-08-08': 'Robię, bo zdecydowałam, nie bo ktoś przyklasnął.',
  '2026-08-09': 'Pytam jak, nie dlaczego. Dlaczego się kręci, jak prowadzi.',
  '2026-08-10': 'Patrzę na liczbę, żeby przestała mnie ścigać.',
  '2026-08-11': 'Zamykam sześć lat porządnie, nie po cichu.',
  '2026-08-12': 'Wiozę ze sobą to, kim jestem, nie to, co udowodniłam.',
  '2026-08-13': 'Wylatuję z pustą głową, nie z pełną listą.',
  '2026-08-14': 'Od teraz mierzę czas tam, gdzie jestem.',
  '2026-08-15': 'Ciało potrzebuje kilku dni. Daję mu je bez pretensji.',
  '2026-08-16': 'Piętnaście minut dla siebie to nadal slot.',
  '2026-08-17': 'Ruszam się, bo mi to daje, nie bo to się liczy.',
  '2026-08-18': 'Jestem tu, gdzie jestem.',
  '2026-08-19': 'Mała decyzja, cały mięsień.',
  '2026-08-20': 'Tożsamość buduje się doświadczeniem, nie perfekcyjną codziennością.',
  '2026-08-21': 'Energia spada, moja wartość nie. To biologia, nie prawda.',
  '2026-08-22': 'Zmieniam plan, nie siebie.',
  '2026-08-23': 'Połowa wyjazdu za mną i nic nie muszę nadrabiać.',
  '2026-08-24': 'Świat poczeka. Ja nie.',
  '2026-08-25': 'Mówię inaczej i świat się nie zawala.',
  '2026-08-26': 'Zamykam wyjazd świadomie, nie w biegu.',
  '2026-08-27': 'Wracam bez nadrabiania.',
  '2026-08-28': 'Wracam do rytmu, nie do nadrabiania.',
